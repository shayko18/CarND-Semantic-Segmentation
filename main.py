...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    layer7_1x1 = tf.layers.conv2d(vgg_layer7_out, num_classes, 1, padding='SAME')       # 1x1 conv for layer 7
    layer7_us = tf.layers.conv2d_transpose(layer7_1x1, num_classes, 4, 2, 'SAME')       # upsample

    layer4_1x1 = tf.layers.conv2d(vgg_layer4_out, num_classes, 1, padding='SAME')       # 1x1 conv for layer 4
    add_74 = tf.add(layer7_us, layer4_1x1)                                              # add layer 4 with the upsamp of layer 7
    
    add_74_us = tf.layers.conv2d_transpose(add_74, num_classes, 4, 2, 'SAME')           # upsample
    
    layer3_1x1 = tf.layers.conv2d(vgg_layer3_out, num_classes, 1, padding='SAME')       # 1x1 conv for layer 3
    add_743 = tf.add(add_74_us, layer3_1x1)                                             # add layer 3 with the upsamp of layer add_74
    
    add_743_us = tf.layers.conv2d_transpose(add_743, num_classes, 16, 8, 'SAME')        # upsample
